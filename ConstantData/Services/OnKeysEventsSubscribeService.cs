...
namespace ConstantData.Services
{
    ...
    public class OnKeysEventsSubscribeService : IOnKeysEventsSubscribeService
    {
        ...
        // но это, кроме идеологически неверного подхода ещё и не позволит вообще делать следующие обновления
        // похоже, надо парсить прямо текст, а не выделываться с мелкими джейсонами
