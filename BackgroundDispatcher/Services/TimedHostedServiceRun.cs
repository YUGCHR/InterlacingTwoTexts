...
namespace BackgroundDispatcher.Services
{
    ...
    public abstract class TimedHostedServiceRun : IHostedService, IDisposable
    {
        ...
        public TimedHostedServiceRun(IServiceProvider services)
        {
            _services = services;
            _logger = _services.GetRequiredService<ILogger<TimedHostedServiceRun>>();
